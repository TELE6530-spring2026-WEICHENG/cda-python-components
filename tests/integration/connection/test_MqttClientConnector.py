...
class MqttClientConnectorTest(unittest.TestCase):
    ...
    def testNewActuatorCmdPubSub(self):
        ...
        self.mcc.publishMessage(
            resource=ResourceNameEnum.CDA_ACTUATOR_CMD_RESOURCE, msg=payload, qos=qos
        )
    ...
    def testSensorMsgPub(self):
        ...
        self.mcc.publishMessage(
            resource=ResourceNameEnum.CDA_SENSOR_MSG_RESOURCE, msg=payload, qos=qos
        )
    ...
    def testCDAActuatorCmdSubscribe(self):
        ...
        self.mcc.connectClient()
        self.mcc.subscribeToTopic(
            resource=ResourceNameEnum.CDA_ACTUATOR_CMD_RESOURCE, qos=qos
        )
